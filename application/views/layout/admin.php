            ...
            <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #23282b;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav">
                        <li>
                            <a class="nav-link" href="/admin/stat">Статистика</a>
                        </li>
                        <li class="">
                            <a class="nav-link" href="/admin/tasks">Все курсы <span class="caret"></span></a>
                        </li>
                        <li class="">
                            <a class="nav-link" href="/admin/logout">Выход <span class="caret"></span></a>
                        </li>
                    </ul>
                </div>
            </nav>
